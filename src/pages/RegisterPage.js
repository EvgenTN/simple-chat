  ...
  return (
    <div className="w-full bg-gray-100 h-screen flex flex-col justify-center items-center">
      ...
      <form name="register" className="bg-white border border-gray-400 rounded px-8 py-8 pt-8" onSubmit={addNewUser}>
        ...
        <input type="text" name="name" value={name} onChange={e => setName(e.target.value)} className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-gray-400"/>
        ...
        <p className="mt-8">
          ...
          <Link to="/login">
            <button className="bg-white hover:bg-gray-100 text-blue-500 font-semibold py-2 px-4 border-none">Login</button>
          </Link>
        </p>
      </form>
    </div>
